...
sudo docker run -p 80:8080   -v /usr/src/nscore/sqllite:/usr/src -v /usr/src/nscore/dotnet/appsettings.json:/App/appsettings.json  --name nscore --hostname nscore  -d nscore
